package com.example.interrogazioni.RandomJSONRPC.src.org.random.api;
...
import com.example.interrogazioni.RandomJSONRPC.src.org.random.api.exception.*;
...
public class RandomOrgClient {
	...
	public RandomOrgClient(String apiKey, long blockingTimeout, int httpTimeout, boolean serialized) {
